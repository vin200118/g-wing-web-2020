  ...
  render(){
    ...
    return (
      ...
      <AlertCom variant={this.state.variant} message={this.state.message} />
          ...
          <FormControl>
          <InputLabel id="flatNo">Flat No</InputLabel>
                              ...
                              <MenuItem value={"G-904"}>G-904</MenuItem>
                                ...
                                <MenuItem value={"G-1004"}>G-1004</MenuItem>
                                  ...
                                  <MenuItem value={"G-1104"}>G-1104</MenuItem>
                                    ...
                                    <MenuItem value={"G-1204"}>G-1024</MenuItem>
            </Select>
     ...
     <div class="row">
       ...
       <input id="password" type="password" class="validate" onChange={e => this.handleChange(e)}/>
       <label for="password">Password</label>
       </div>
     </div>
     <a class="waves-effect waves-light btn-small" onClick={this.login}>Login</a>
